...
return api.sendMessage(
  global.getText("handleCommand", "permissionNotEnough", command.config.name) || "Lệnh này đang cập nhật, sẽ có trong tương lai",
  event.threadID || "Default threadID",
  event.messageID || "Default messageID"
);
