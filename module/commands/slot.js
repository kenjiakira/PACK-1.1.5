const slotSymbols = ["🍒", "🍋", "🍇", "🍀", "🍉", "🍊", "🍎", "💎", "⭐"];
const betAmounts = [100, 200, 500, 1000, 2000];
...
module.exports.run = async ({ api, event, args, Currencies, Users }) => {
  ...
  } else if (spinResult.includes(slotSymbols.indexOf(scatterSymbol))) {
    message += `🎉 ${winnerName} đã nhận được lượt quay miễn phí! Chúc may mắn hơn!`;
